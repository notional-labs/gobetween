...
### Fixed
 - CGO Requirement for DNS has been replaced with netgo [#125](https://github.com/notional-labs/gobetween/issues/125)
 - UDP server was not performing access checks
 - Empty `srv_dns_protocol` messed up failpolicy value [#193](https://github.com/notional-labs/gobetween/issues/193)
 - Fixed missing acme (letsencrypt) tls config during server start [#214](https://github.com/notional-labs/gobetween/issues/214)
